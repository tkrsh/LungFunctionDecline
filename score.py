...
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir="/home/tkrsh/osic", profile_batch=5)

model.fit(train_dataset,epochs=200,callbacks=[tensorboard_callback])

 
model.save_weights("base_tab")
model.save("base")
